...
obstacles = []
obstacles.append(Obstacles((600,400),75,True))
obstacles.append(Obstacles((1050,250),40,True))
obstacles.append(Obstacles((1100,600),50,True))
obstacles.append(Obstacles((600,700),100,True))
obstacles.append(Obstacles((300,100),50,True))
obstacles.append(Obstacles((900,400),50,True))
obstacles.append(Obstacles((500,40),50,True))
obstacles.append(Obstacles((10,700),50,True))
obstacles.append(Obstacles((40,200),50,True))

#running variable is used to 
running = True
...
while step < maxStep  and running:
  ...
  #if greedy button pressed, change the value of epsilon to 0.05
